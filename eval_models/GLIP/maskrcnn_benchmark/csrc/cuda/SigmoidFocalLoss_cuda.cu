...
// removed deprecated THC includes
...
at::Tensor SigmoidFocalLoss_forward_cuda(
  ...
  dim3 grid(std::min<int64_t>(at::ceil_div((int64_t)losses_size, (int64_t)512), (int64_t)4096));
  dim3 block(512);
...
at::Tensor SigmoidFocalLoss_backward_cuda(
  ...
  dim3 grid(std::min<int64_t>(at::ceil_div((int64_t)d_logits_size, (int64_t)512), (int64_t)4096));
  dim3 block(512);
