...
at::Tensor ROIAlign_forward_cuda(const at::Tensor& input,
  ...
  int blocks = std::min<int64_t>(at::ceil_div((int64_t)output_size, (int64_t)512), (int64_t)4096);
  dim3 grid(blocks);
  dim3 block(512);
...
at::Tensor ROIAlign_backward_cuda(const at::Tensor& grad,
  ...
  int blocks = std::min<int64_t>(at::ceil_div((int64_t)grad.numel(), (int64_t)512), (int64_t)4096);
  dim3 grid(blocks);
  dim3 block(512);
